...
pip_install()
{
    ...
    chmod 777 /usr/local/lib/python2.7/dist-packages -R
    rm requirements.txt
}
...
{
    apt-get update
    apt-get install htop vim-nox libjpeg-dev zlib1g-dev libffi-dev g++ librdkafka-dev build-essential libssl-dev python-dev libtiff5-dev libjpeg8-dev zlib1g-dev libfreetype6-dev liblcms2-dev libwebp-dev tcl8.6-dev tk8.6-dev python-tk freetds-dev -y
}
